...
<div class="resou" id="socode_top"> 
    ...
    <a target='_parent' href="./so.php?wd=<?php echo rawurlencode($key); ?>"  title='人气：<?php echo $val; ?>℃'><?php echo $key; ?></a>
    <?php $i++; if($i==5){break;}?>
    <?php endforeach; ?>
   
    <a  target='_parent' href="javascript:void(0);" onclick="echotop();">更多...</a>
