...
//var_dump( YUN::getvideo("https://v.qq.com/x/cover/mzc0020002ka95z/d0036o17h0n.html"));
...
//根据资源站序号及视频ID取视频信息
  ...
  public static function getid($api,$name,$num)
 {
     ...
     //根据标题取ID
	 $data=self::curl($api."?wd=".rawurlencode($name)); if ($data==""){return false;};	 
